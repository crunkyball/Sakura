...
SaFileJob::SaFileJob(EJobType jobType, SaFileHandle* pHandle, SaFileHandle::CallbackFunc pCallbackFunc, void* pCallbackUserData) :
    m_jobType(jobType),
...
void SaFileJob::GetCallback(SaFileHandle::CallbackFunc& rCallbackFunc, void*& rpCallbackUserData)
{
    rCallbackFunc = m_callbackFunc;
    rpCallbackUserData = m_pCallbackUserData;
}

SaFileJob::EJobType SaFileJob::GetJobType() const
{
    return m_jobType;
}

SaFileHandle* SaFileJob::GetFileHandle() const
{
